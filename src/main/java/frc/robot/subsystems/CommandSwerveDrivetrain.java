...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void dashbaordValues() {
         ...
         * I could add invidual modules
         */
        SmartDashboard.putNumber("X Speed", this.getState().Speeds.vxMetersPerSecond);
        SmartDashboard.putNumber("Y Speed", this.getState().Speeds.vyMetersPerSecond);
        SmartDashboard.putNumber("Raw Heading", this.getState().RawHeading.getDegrees());
    }
    ...
    private void configurePathPlanner() {
        ...
        AutoBuilder.configure(
                ...
                new PPHolonomicDriveController(
                        RobotConstants.Autos.TRANSLATION_PID,
                        RobotConstants.Autos.ROTATION_PID),
                config,
                this::allianceCheck,
                this);
    }
