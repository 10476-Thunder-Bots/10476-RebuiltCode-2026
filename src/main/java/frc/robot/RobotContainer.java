...
public class RobotContainer {
    ...
    private final CommandJoystick dancepad = new CommandJoystick(2);
    ...
    private void configureBindings() {
        ...
        dancepad.button(1).whileTrue(drivetrain.applyRequest(() -> drive.withVelocityY(MaxSpeed / 2)));
        dancepad.button(4).whileTrue(drivetrain.applyRequest(() -> drive.withVelocityY(-MaxSpeed / 2)));
